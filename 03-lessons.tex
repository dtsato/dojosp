...
{\Large you say that some ideas have been suggested - I'd like to know
  ...
  Tentei algo lá. Não dá para ficar enunciando muita coisa por conta
  do limite de páginas. Hugo}
...
participants have not yet found a solution to this, but a possible
solution have been proposed. It states that, during each coding
time-box, anyone from the audience can request a pause to have a 7
minutes (or less) time-boxed discussion. During that time, the coding
pair should conduct the discussion. Once the time is over, their
coding time-box continues. Another alternative is to intercal those
coding time-boxes and the discussions one with the possibility to skip
the discussion if it is not needed. 
