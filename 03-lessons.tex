...
\item \textbf{``What has hindered learning?''}: The negative aspects
  ...
  identified. For these impediments, the group discusses how they could be
  eliminates and come up with a series of action items. People are assigned
  to handle each action item and the results are recorded for future reflection.
\end{itemize}
...
One interesting tool that was also appreciated by the participants was
to have an ``Inspiration Moment'' prior to the discussions. The moderator
used to choose a card from the Creative Whack Pack~\cite{Creative}
containing a different creativity strategy that inspired the thought
process and gave insights into how to approach the problem.
